                    ...
                    if(lib.config.extension_术樱_randomoff){
                        ...
                        if(Newlist==''||Newlist==undefined||Newlist.length==1){
                            if(lib.config.extension_术樱_tianshu_addBoss&&_status.Diuse_Xvni_Bool==false){
                                if(Newlist.length<=2){
                                    alert('检测到关闭虚拟偶像，请检查Boss列表或Boss数量不足三个，即将重启');
                                    setTimeout(function(){
            ...
            game.Benghuai3("Benghuai3","崩坏3",{
                ...
                cheat:{ //cfg
                    cfg:function(){
                        ...
                        game.saveConfig('Diuse_local_version','1.7.44.12'); 
            ...
            game.Tianshu("Tianshu","天书乱斗",{
                character:{
                    character:{
                        ...
                        Boss_Diuse_Jiuzi:["male","",0,["Boss_Jiuzi_Go","Boss_Diuse_Jiuzi_intro1","Boss_Diuse_Jiuzi_intro2","Boss_Diuse_Jiuzi_intro3","Boss_Diuse_Jiuzi_intro4","Boss_Diuse_Jiuzi_intro5"],["boss"],"qun"],
                ...
                game:{ //Boss自定义函数处
                    ...
                    skillsList:function(){ //普通技能
                        var skills=[];
                        var banned=[
                            'huoxin','jueqing','qinqing','beige','huashen','drlt_zhiti','olzhiti','xinfu_pdgyingshi'
                        ];
                        var characters=[];
            ...
            game.Diy("Diuse_Diy","DIY",{
                ...
                skill:{
                    skill:{
                        ...
                        Diuse_Jijiang1:{
                            ...
                            content:function(){
                                ...
                                trigger.getParent().set('Diuse_Jijiang',true);
                                "step 1"
                        ...
                        Diuse_Xiahui:{
                            ...
                            subSkill:{
                                gain:{
                                    ...
                                    content:function(){
                                        'step 0'
                                        var color=get.color(trigger.cards);
                                        if(color=='black'){
                                            ...
                                            var bool=game.hasPlayer(function(target){
                                                if(player.canUse(trigger.cards[0],target)){
                                                    return true;
                                                } else {
                                                    return false;
                                                }
                                            });
                                            if(bool) player.chooseBool('是否令'+get.translation(trigger.target)+'使用'+get.translation(trigger.cards));
                                        }
                                        'step 1'
                                        if(result.bool){
                                            trigger.player.chooseUseTarget(trigger.cards,true);
                                        }
                                    },
                                },
                                block:{
                    ...
                    translate:{
                        ...
                        Diuse_Jiuyuan_info:"锁定技，其他吴势力角色对你使用【桃】的回复值+1且你与其各摸一张牌。",
                        ...
                        Diuse_Lianzhu_info:"出牌阶段限一次，你将一张手牌正面朝上交给一名其他角色。若此牌为红色，你摸一张牌，若此时你没有手牌则额外摸一张；黑色，其弃两张牌或令你摸两张若其因此手牌均为“黠慧”牌和你没有手牌则额外摸一张牌",
                        Diuse_Xiahui_info:"锁定技，你的黑色手牌不计入手牌上限；当有其他角色获得你的黑色牌后，其于下次扣减体力前不能使用，打出，弃置这些牌；当有角色因弃置而失去你的黑色牌时，其失去一点体力。当有角色获得你的红色牌后你可以令其使用之",
                    },
                },
            },"术樱");
        }
