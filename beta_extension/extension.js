            ...
            game.Benghuai3("Benghuai3","崩坏3",{
                ...
                character:{
                    character:{
                        ...
                        Diuse_Yingtao:["female","qun",2,['Diuse_Huojian'],['unseen']],
                        Diuse_Lanmei:["female","qun",3,['Diuse_Huyuan'],['unseen']],
                        //,'kagari_zongsi'
                    },
                    translate:{
                        Diuse_Xier:"希儿",
                ...
                skill:{
                    skill:{
                        ...
                        Diuse_Huyuan:{
                            ...
                            usable:1,
                            init:function(player){
                                player.storage.Newdualside=[];
                                player.storage.Newcard=[];
                                player.storage.Newdualside_over=false;
                            },
                            check:function (card){
                                return 1;
                            },
                            ...
                            content:function (event,player,targets)
                            {
                                var bool=player.storage.Newdualside_over;
                                if(bool==false){
                                    ...
                                    player.markSkillCharacter('Diuse_Newmark_Lanmei',{name:'Diuse_Lanmei'},'莉莉娅','当前体力：'+cfg[0]+'/'+cfg[1]);
                            ...
                            group:["Diuse_Huyuan_Game","Diuse_Huyuan_Die","Diuse_Huyuan_Draw"],
                            subSkill:{
                                Game:{
                                    trigger:{global:'gameStart',player:'enterGame'},
                                    silent:true,
                                    filter:function(event,player){
                                        if(!player.storage.Newdualside) return false;
                                    ...
                                    content:function(){
                                        ...
                                        var cfg=player.storage.Newdualside;
                                        player.markSkillCharacter('Diuse_Newmark_Yingtao',{name:'Diuse_Yingtao'},'萝莎莉娅','当前体力：'+cfg[2]+'/'+cfg[3]);
                                    },
                                },
                                Die:{
                        ...
                        Diuse_Huojian:{
                            ...
                            group:["Diuse_Huojian_Game","Diuse_Huojian_Die","Diuse_Huojian_Draw"],
                            subSkill:{
                                Game:{
                                    trigger:{global:'gameStart',player:'enterGame'},
                                    silent:true,
                                    ...
                                    content:function(){
                                        ...
                                        var cfg=player.storage.Newdualside;
                                        player.unmarkSkill('Diuse_Newmark_Lanmei');
                                        player.markSkillCharacter('Diuse_Newmark_Lanmei',{name:'Diuse_Lanmei'},'莉莉娅','当前体力：'+cfg[0]+'/'+cfg[1]),'手牌：'+player.getExpansions('Diuse_Newcard');
                                    },
                                },
                                Die:{
                                    trigger:{player:'dieBefore'},
        ...
        if(lib.config.extension_术樱_tianshuoff&&lib.config.mode=='boss'){
            game.Tianshu=function(英文名,翻译名,obj,扩展包名){
                ...
                lib.element.player.bossName=function(num,a){ //全部boss 可以用于调用和匹配boss
                    ...
                    var oneList=['Shengxiao_Youji','shen_guanyu'];
