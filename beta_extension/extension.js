...
precontent:function (Diuse){
    ...
    if(Diuse.enable){
        ...
        game.saveConfig('Diuse_local_version','1.7.44.11');
                ...
                skill:{
                    skill:{
                        ...
                        Diuse_San:{
                            ...
                            content:function(){
                                "step 0"
                                player.chooseTarget(get.prompt('Diuse_San'),'选择一名角色受到无伤害来源的伤害').set('ai',function(player,target){
                        ...
                        Diuse_Honghong:{
                            ...
                            content:function(){
                                ...
                                if(result.bool){
                                    ...
                                    player.chooseUseTarget(event.card,false).set('ai',function(player,target){
                        ...
                        Diuse_DIY_Zhuhai:{
                            ...
                            content:function(){
                                ...
                                player.chooseControl('杀','过河拆桥','cancel').set('prompt','请选择对'+get.translation(trigger.player)+'使用一张').set('ai',function(event,player,target){
                                    if(get.attitude(player,trigger.player)>0) return 'cancel';
