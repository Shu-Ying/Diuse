...
precontent:function (Diuse){
    ...
    if(Diuse.enable){
        ...
        game.saveConfig('Diuse_local_version','1.7.44.8');
        ...
        lib.skill._Tianshu_checkPoint={ //Boss阵亡和奖励
            ...
            content:function(){
                ...
                'step 3'
                if(_status.Diuse_Tianshu_checkPoint>5) if(parseInt(_status.Diuse_Tianshu_checkPoint%5)!=0) player.hidePlayer(); event.goto(0);
                'step 4'
                var off;
            ...
            subSkill:{
                ...
                Jieshu:{ 
                    ...
                    popup:false,
                    filter:function(event,player){
                        return player.isFriendOf(game.boss)&&_status.Diuse_Tianshu_Bool&&lib.config.extension_术樱_baizhanoff&&_status.Diuse_Tianshu_Jieshu;
                    },
                    content:function(){
                ...
                Damage:{ 
                    ...
                    popup:false,
                    filter:function(event,player){
                        return player.isFriendOf(game.boss)&&_status.Diuse_Tianshu_Bool&&lib.config.extension_术樱_baizhanoff&&_status.Diuse_Tianshu_Damage;
                    },
                    content:function(){
