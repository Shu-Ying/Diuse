...
precontent:function (Diuse){
    ...
    if(Diuse.enable){
        ...
        game.saveConfig('Diuse_local_version','1.7.44.6');
        ...
        lib.skill._Tianshu_checkPoint={ //Boss阵亡和奖励
            ...
            content:function(){
                        ...
                        for(var i=0;i<game.players.length;i++){
                            if(game.players[i].name==name1||game.players[i].name==name2&&!game.players[i].isFriendOf(player)){
                                if(num2==1){
                                    ...
                                    if(_status.Diuse_Tianshu_checkPoint>5){
                                        var markNum=_status.Diuse_Tianshu_checkPoint;
                ...
                for(var D=0;D<game.players.length;D++){
                    ...
                    if(game.players[D].bossName(0)) continue;
                    if(!game.players[D].isFriendOf(player)) event.Diuse_Player.add(game.players[D]);
                }
                'step 3'
                if(_status.Diuse_Tianshu_checkPoint>5) if(parseInt(_status.Diuse_Tianshu_checkPoint%5)!=0) event.goto(0);
                'step 4'
                var off;
        ...
        lib.element.player.removeAllSkills=function(){ //移除全部技能
            game.playerDead(); //先让玩家阵亡角色复活
            for(var i=0;i<game.players.length;i++){
                game.players[i].addSkill('removeSkills');
            }
        };

        lib.element.player.addAllSkills=function(){ //恢复全部技能
            for(var i=0;i<game.players.length;i++){
                game.players[i].removeSkill('removeSkills');
            }
        };
        ...
        lib.element.player.hidePlayer=function(){ //隐藏Boss
            for(var i=0;i<game.dead.length;i++){
                this.hide();
                if(game.dead[i].isFriendOf(this)) {
                    game.dead[i].hide();
                }
            }
        };
                ...
                skill:{
                    skill:{
                            ...
                            subSkill:{
                                Damage:{
                                    ...
                                    content:function(){
                                        ...
                                        trigger.cancel();
                                        var next=player.chooseToUse();
                                        next.set('targets',trigger.source);
                                        next.set('norestore',true);
                        ...
                        Diuse_Huyuan:{
                            ...
                            group:["Diuse_Huyuan_Game","Diuse_Huyuan_Die","Diuse_Huyuan_Swap"],
                            subSkill:{
                                Game:{
                                    trigger:{global:'gameStart',player:'enterGame'},
                                    silent:true,
                                    filter:function(event,player){
                                        return player.name=='Diuse_Lanmei';
                                    },
                                    content:function(){
                                        'step 0'
                                        ...
                                        var name=lib.character['Diuse_Yingtao'];
                                        event.cards=[];
                                        event.num=0;
                                ...
                                Swap:{
                                    ...
                                    filter:function(event,player){
                                        var cfg=player.storage.Newdualside;
                                        if(cfg==undefined||cfg=='') return false;
                                        return game.hasPlayer(function(current){
                                            return current.countCards('ej')>=1;
                                        })||cfg[2]<cfg[3];
                                    },
                                    content:function(){
                                        var cfg=player.storage.Newdualside;
                        ...
                        Diuse_Huojian:{
                            ...
                            group:["Diuse_Huojian_Game","Diuse_Huojian_Die","Diuse_Huojian_Swap","Diuse_Huojian_Lose"],
                            subSkill:{
                                Game:{
                                    trigger:{global:'gameStart',player:'enterGame'},
                                    silent:true,
                                    filter:function(event,player){
                                        return player.name=='Diuse_Yingtao';
                                    },
                                    content:function(){
                                        'step 0'
                                        ...
                                        if(player.storage.Newdualside==undefined) player.storage.Newdualside=[];
                                        if(player.storage.Newdualside_over) player.storage.Newdualside_over=false;
                                        var name=lib.character['Diuse_Lanmei'];
                                        event.cards=[];
                                        event.num=0;
                        ...
                        Diuse_Shanliang:{
                            ...
                            content:function(){
                                ...
                                'step 4'
                                if(result.bool){
                                    event.num=player.storage.Diuse_Shanliang_Num;
                    ...
                    playerDead:function(){ //复活
                        ...
                        for(var i=0;i<dead.length;i++){
                            if(!dead[i].side&&dead[i].maxHp>0/*&&dead[i].parentNode==game.players[i].parentNode*/){
                                if(!lib.config.extension_术樱_tianshu_dead) if(dead[i].bossName(0)) continue;
